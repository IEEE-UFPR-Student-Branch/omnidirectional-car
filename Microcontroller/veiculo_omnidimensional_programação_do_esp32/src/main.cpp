...
void loop() {
  ...
  if (bt.available()) {
    ...
    case '1':
      ...
      girar_motor_frente(front1v_left, front2v_left, front1v_right,
                         front2v_right, frontleftengine, frontrightengine, 255);
      girar_motor_frente(back1v_left, back2v_left, back1v_right, back2v_right,
                         backleftengine, back1v_right, 255);
      delay(1);
      break;

    case '2':
      // Veiculo andando para tras
      girar_motor_tras(front1v_left, front2v_left, front1v_right, front2v_right,
                       frontleftengine, frontrightengine, 255);
      girar_motor_tras(back1v_left, back2v_left, back1v_right, back2v_right,
                       backleftengine, back1v_right, 255);
      delay(1);
      break;
    ...
    default:
      // Veiculo parado
      girar_motor_frente(front1v_left, front2v_left, front1v_right,
                         front2v_right, frontleftengine, frontrightengine, 0);
      girar_motor_frente(back1v_left, back2v_left, back1v_right, back2v_right,
                         backleftengine, back1v_right, 0);
      delay(1);
    }
  }
}

void girar_motor_frente(int variavel1, int variavel2, int variavel3,
                        int variavel4, int pino_velocidade1,
                        int pino_velocidade2, int velocidade) {
...
void girar_motor_tras(int variavel11, int variavel22, int variavel33,
                      int variavel44, int pino_velocidade1,
                      int pino_velocidade2, int velocidade1) {
